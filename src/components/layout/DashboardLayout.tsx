        ...
        <div className="h-16 flex items-center px-6 border-b border-border/50">
          <div className="flex items-center gap-2">
            ...
            <span className="font-display font-bold text-xl tracking-tight">
              NWU <span className="text-primary">PROTOCOL</span>
            </span>
          </div>
        </div>
        ...
        <header className="h-16 flex items-center justify-between px-6 bg-background/80 backdrop-blur-md border-b border-border/50 sticky top-0 z-10">
          <div className="flex items-center gap-4">
            ...
            <div className="hidden lg:flex items-center gap-2 px-3 py-1.5 rounded-full bg-muted/50 border border-border/50 text-xs font-medium text-muted-foreground">
              ...
              Network Status:{' '}
              <span className="text-primary uppercase tracking-wider">Mainnet Alpha</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            <Button
              variant="outline"
              className="hidden sm:flex gap-2 rounded-full border-primary/30 hover:border-primary hover:bg-primary/5 transition-all"
            >
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="ghost"
                  size="icon"
                  className="rounded-full ring-1 ring-border/50 hover:ring-primary/50 transition-all p-0"
                >
